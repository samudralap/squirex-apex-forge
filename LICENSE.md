...
## PERMITTED USES
- ✅ View source code for reference/education
- ✅ Submit contributions via pull requests
- ✅ Personal, non-commercial evaluation
- ✅ Download and use official binary releases

## PROHIBITED USES
- ❌ Copying, redistributing, or republishing
- ❌ Creating derivative works or similar software
- ❌ Commercial use without a license
- ❌ Forking to create independent projects
...
Build Signature: ApexForge-Official-Release
